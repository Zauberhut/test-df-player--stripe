...
input.onButtonPressed(Button.AB, function () {
    matrix.scrollText("guten Tag ", 94, neopixel.colors(NeoPixelColors.Red))
})
...
matrix = neopixel.create_matrix(HiwonderPins.P16, matrixSizes.medium_32x8, PowerSource.Extern)
